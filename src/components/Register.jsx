...
function Register() {
  ...
  return (
    <div className='flex flex-col items-center h-full py-10 bg-gray-50 md:h-screen'>
                <div className='flex justify-between md:px-20 px-10 w-full '>
                    <Link
                        to="/"
                    >
                    ...
                    <div className='flex justify-center items-center gap-3'>
                        <p className='hidden md:flex font-bold text-px opacity-70 text-black'>Already have an account?</p>    
                        <Link
                            to="/Login"
                            className='text-black font-bold text-md hover:text-blue-500'
                        >
                            <span>Login</span>
                ...
                <div className='flex flex-col items-center h-full w-full md:pt-16 pt-10'>
                    <div className='px-5 md:px-10 h-auto md:w-2/6 w-5/6 flex flex-col items-center rounded-md gap-4 border-gray-100 border bg-white py-8 shadow-xl'>
                        ...
                        <button
                            type='button'
                            className='bg-blue-600 text-white px-6 py-2 rounded-md font-semibold text-base outline-none w-full focus:border-blue-400'
                            onClick={Register}
                        >
                            Rigister
                        </button>
