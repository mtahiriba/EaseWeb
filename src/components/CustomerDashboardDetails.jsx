        ...
        <div className='flex pt-5 gap-10 md:px-20 px-4 md:flex-row flex-col'>
          <div className='flex flex-col gap-5 md:w-2/5 w-full'>
            ...
            <div className='w-full flex flex-col gap-3 h-48'>
                  <div className='h-2/5 flex justify-between items-center rounded-md bg-white border px-7 shadow-md'>
                      <div className='flex gap-5 flex-row items-center w-10/12'>
                        ...
                        <span className='text-sm mr-5 font-sans' >Current Website Progress</span>
                        <div className='w-32'>
                      ...
                      <button 
                        type='button'
                        className='bg-green-500 text-white px-3 py-1 rounded-md font-semibold text-base outline-none hover:bg-green-600 hover:border-green-600 border-green-500 border-2 block'
                      >
                        Continue
                      </button>
                  ...
                  <div className='h-3/5 flex justify-between items-center gap-3'>
                      <div className='rounded-md bg-white border w-1/2 h-full flex justify-start items-center gap-3 px-12 shadow-md'>
                        <span className='text-6xl font-bold'>{sectionNum}</span>
                        <span className='font-sans text-sm '>Custom designed templates</span>
                      </div>
                      <div className=' rounded-md bg-white border w-1/2 h-full flex justify-start items-center gap-3 px-12 shadow-md'>
                        <span className='text-6xl font-bold'>{websiteNum}</span>
                        <span className='font-sans text-sm'>Designed <br /> websites</span>
                      </div>
                  </div>
            </div>
          </div>
          <div className='md:w-3/5 w-full'>
            ...
            <div className=' w-full flex h-96 '>
                {activeButton === 'design' ? <DesignWebsiteDashboard setWebsiteNum={setWebsiteNum} user={user}/> : <CustomTemplatesDashboard setSectionNum={setSectionNum}/>}
            </div>
          </div>
      </div>
    </div>
